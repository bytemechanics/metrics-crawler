 ...
 *	    (...)
 *      try(DurationSensor sensor2=DurationSensor.get("myMeasure2{}",2)){
 *          (...)
 *          try(DurationSensor sensor2=DurationSensor.get("myMeasure3{}",3)){
 *               (...)
 *          }
 *		}
 *      try(DurationSensor sensor2=DurationSensor.get("myMeasure4{}",4)){
 *          (...)
 *		}
 *  }
 * }</pre>
 ...
 * <ul>
 *		<li>myMeasure11=[measure1Duration]</li>
 *		<li>myMeasure11.myMeasure22=[measure2Duration]</li>
 *		<li>myMeasure11.myMeasure22.myMeasure33=[measure3Duration]</li>
 *		<li>myMeasure11.myMeasure44=[measure4Duration]</li>
 * </ul>
...
public class DurationStackSensor extends AbstractStackSensor<Duration>{
	 ...
	 */
	protected DurationStackSensor(final String _name,final Object... _args){
	 ...
	 * @see AbstractStackSensor#getMeasure() 
	 */
	@Override
	...
	public static DurationStackSensor get(final String _name,final Object... _args){
		return new DurationStackSensor(_name,_args);
	}
}
