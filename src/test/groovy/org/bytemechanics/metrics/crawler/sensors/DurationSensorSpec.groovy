...
class DurationSensorSpec extends Specification{
	...
	def "When create a double sensor with get(_name:#name,_args:#args) and then call getName() should return #expected"(){
		println(">>>>> DurationSensorSpec >>>> When create a double sensor with get(_name:$name,_args:$args) and then call getName() should return $expected")
	...
	@Unroll
	def "When create a double sensor with get(_name:#name,_args:#args) and then call isSkip() should return false"(){
		println(">>>>> DurationSensorSpec >>>> When create a double sensor with get(_name:$name,_args:$args) and then call isSkip() should return false")
	...
	def "When create a double sensor with get(_measure:#measure,_name:#name,_args:#args) and call skip() then isSkip() return true"(){
		println(">>>>> DurationSensorSpec >>>> When create a double sensor with get(_measure:#measure,_name:$name,_args:$args) and call skip() then isSkip() return true")
